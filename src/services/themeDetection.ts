...
const FEAR_KEYWORDS: Record<Exclude<FearTheme, 'other'>, string[]> = {
  ...
  injury: ['hurt', 'injury', 'pain', 'knees', 'back', 'joints', 'damage', 'make it worse'],
  judgment: ['judge', 'think of me', 'opinions', 'what people', 'others think', 'embarrassing'],
};
...
const ANCHOR_KEYWORDS: Record<Exclude<AnchorTheme, 'other'>, string[]> = {
  ...
  parents: ['mom', 'dad', 'mother', 'father', 'parents', 'parent'],
  family_general: ['family', 'loved ones', 'everyone', 'people who', 'those who care'],
  future_self: [
    'future',
    'older',
    'years from now',
  ...
  self_only: ['just me', 'only me', 'no one else', 'just for me', 'myself only'],
};

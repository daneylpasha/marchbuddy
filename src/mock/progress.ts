...
export const mockMeasurements: BodyMeasurement[] = [
  ...
  },
  {
    ...
    chest: 103,
    arms: 36,
    notes: 'Good progress on waist, arms growing',
  },
];
...
export const mockWeeklySummaries: WeeklySummary[] = [
  {
    ...
    summaryText:
      'Strong week overall. You completed 5 out of 5 planned workouts and stayed within your calorie targets on 6 days. Your bench press volume increased by 5% and bodyweight dropped 0.5 kg. Keep pushing on the compound lifts.',
    insights: [
  ...
  },
  {
    ...
    summaryText:
      'Good consistency this week with 4 out of 5 workouts completed. You skipped Friday due to low energy but made it up with an extra active-recovery session. Nutrition was on point with an average deficit of ~350 cal/day.',
    insights: [
